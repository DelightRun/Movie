...
<head>
    ...
    <title>用户中心-用户余额|电影票网_电影在线选座购票平台</title>
    ...
    <div class="container fn-clear">
        ...
        <div class="box-con account-usercenter">
            <div class="account-info">
                <h3>账户余额</h3>
                <p class="fn-clear"><span class="fn-left pt">当前余额：</span><em id="account" class="fn-left pt">${movie_account.balance}点</em><a href="user-pay-to-account" class="fn-left btn">充值</a></p>
            </div>
