    ...
    <main class="lyear-layout-content">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header"><h4>编辑排片场次</h4></div>
              <div class="card-body">
                <form action="add" id="cinema-hall-add-form" method="post" class="row">
                  ...
                  <div class="input-group m-b-10">
                    ...
                    <input type="text" class="form-control required js-datetimepicker" id="show-date" name="showDate" value="${cinemaHallSession.showDate}" placeholder="请选择场次放映日期" tips="请选择场次放映日期" data-side-by-side="true" data-locale="zh-cn" data-format="YYYY-MM-DD" />
                  </div>
                  <div class="input-group m-b-10">
                    <span class="input-group-addon">放映时间</span>
                    <input type="text" class="form-control required js-datetimepicker" id="show-time" name="showTime" value="${cinemaHallSession.showTime}" placeholder="请选择场次放映时间" tips="请选择场次放映时间" data-side-by-side="true" data-locale="zh-cn" data-format="HH:mm" />
                  </div>
                  <div class="input-group m-b-10">
                    <span class="input-group-addon">影票原价</span>
                    <input type="number" class="form-control required" id="old-price" name="oldPrice" value="${cinemaHallSession.oldPrice!"0"}" placeholder="请填写影票原价" tips="请填写影票原价" />
                  </div>
                  <div class="input-group m-b-10">
                    <span class="input-group-addon">影票现价</span>
                    <input type="number" class="form-control required" id="new-price" name="newPrice" value="${cinemaHallSession.newPrice!"0"}" placeholder="请填写影票现价" tips="请填写影票现价" />
                  </div>
