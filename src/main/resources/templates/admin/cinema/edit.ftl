    ...
    <main class="lyear-layout-content">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header"><h4>编辑电影院</h4></div>
              <div class="card-body">
                <form action="add" id="cinema-add-form" method="post" class="row">
                  ...
                  <div class="input-group m-b-10">
                    ...
                    <input type="text" class="form-control required" id="name" name="name" value="${cinema.name}" placeholder="请输入电影院名" tips="请填写电影院名" />
                  </div>
                  <div class="input-group m-b-10">
                  ...
                  <div class="input-group m-b-10">
                    ...
                    <input type="hidden" name="cinemaService" id="cinema-service" value="${cinema.cinemaService}" class="required" tips="请选择电影院服务">
                  </div>
                  <div class="input-group m-b-10">
                    <span class="input-group-addon">影院地址</span>
                    <input type="text" class="form-control required" id="address" name="address" value="${cinema.address!""}" placeholder="请填写电影院详细地址" tips="请填写电影院详细地址" />
                  </div>
                  <div class="input-group m-b-10">
                    <span class="input-group-addon">联系电话</span>
                    <input type="text" class="form-control required" id="tel" name="tel" value="${cinema.tel!""}" placeholder="请填写电影院联系电话" tips="请填写电影院联系电话" />
                  </div>
                  <div class="input-group m-b-10">
                    <span class="input-group-addon">交通路线</span>
                    <input type="text" class="form-control required" id="transport" name="transport" value="${cinema.transport!""}" placeholder="请填写电影院交通路线" tips="请填写电影院交通路线" />
                  </div>
                  <div class="input-group m-b-10">
                    <span class="input-group-addon">影院介绍</span>
                    <textarea class="form-control" id="info" name="info" rows="5" placeholder="请填写电影院介绍">${cinema.info!""}</textarea>
                  </div>
