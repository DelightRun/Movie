            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="edit-avatar">
                  <#if movie_user.headPic??>
	            		<#if movie_user.headPic?length gt 0>
	            		<img src="/photo/view?filename=${movie_user.headPic}" id="show-img" class="img-avatar">
	            		<#else>
                ...
                <form method="post" action="update_userinfo" class="site-form">
                  <input type="hidden" name="headPic" id="headPic" value="${movie_user.headPic!""}">
                  <div class="form-group">
                    <label for="username">用户名</label>
                    <input type="text" class="form-control" name="username" id="username" value="${movie_user.username}" disabled="disabled" />
                  </div>
                  <div class="form-group">
                    <label for="nickname">手机</label>
                    <input type="text" class="form-control" name="mobile" id="mobile" placeholder="输入您的手机号码" value="${movie_user.mobile!""}">
                  </div>
                  <div class="form-group">
                    <label for="email">邮箱</label>
                    <input type="email" class="form-control" name="email" id="email" aria-describedby="emailHelp" placeholder="请输入正确的邮箱地址" value="${movie_user.email!""}">
                  </div>
