            ...
            <li class="dropdown dropdown-profile">
              <a href="javascript:void(0)" data-toggle="dropdown">
                 ...
                 <#if movie_user.headPic?length gt 0>
                	<img class="img-avatar img-avatar-48 m-r-10" src="/photo/view?filename=${movie_user.headPic}" alt="${movie_user.username!""}" />
                 <#else>
                 	<img class="img-avatar img-avatar-48 m-r-10" src="/admin/images/default-head.jpg" alt="${movie_user.username!""}" />
                 </#if>
                 </#if>
                <span>${movie_user.username!""} <span class="caret"></span></span>
              </a>
