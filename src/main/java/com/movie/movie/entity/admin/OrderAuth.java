package com.movie.movie.entity.admin;
/**
 * 订单验证日志记录表
 */

import com.movie.movie.annotion.ValidateEntity;
import com.movie.movie.entity.common.BaseEntity;
