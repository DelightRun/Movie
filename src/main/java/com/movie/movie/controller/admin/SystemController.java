...
public class SystemController {
    ...
    public String index(Model model) {
        ...
        model.addAttribute("nan", accountService.rs(1));
        model.addAttribute("nv", accountService.rs(2));
